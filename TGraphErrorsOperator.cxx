/**
 * \file TGraphErrorsOperator.cxx
 * \brief Implementation of TGraphErrors / TGraphAsymmErrors operators and utilities.
 *
 * \author Yicheng Feng
 * Email:  fengyich@outlook.com
 */

#include "TGraphErrorsOperator.h"
...
TGraphErrors operator+(const TGraphErrors &g1, double c) { return c + g1; }
...
TGraphErrors operator-(double c, const TGraphErrors &g1) { return c + (-1.0 * g1); }
TGraphErrors operator-(const TGraphErrors &g1, double c) { return g1 + (-1.0 * c); }
...
TGraphErrors GraphCent9(const TGraphErrors &g1) { return GraphCent(g1); }
